...
"resource": {
  ...
  "rules":[
    [["if",2],["unless",0,1],["add",0,6,7,15,16,17,18,19,20,22,27]],
    [["if",4,15,16],["unless",1],["add",1,10,13,15,24]],
    [["if",4,17],["unless",1],["add",2,4,5,15,23]],
    [["if",4,18],["unless",1],["add",3,9,12,15,25]],
    [["if",22,23],["add",8,11,14,15,26]],
    [["if",23],["add",21]],
    [["if",3,4],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,22,23,24,25,27]],
    [["if",4,5],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,22,23,24,25,27]],
    [["if",4,6],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,22,23,24,25,27]],
    [["if",4,7],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,22,23,24,25,27]],
    [["if",4,8],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,22,23,24,25,27]],
    [["if",4,9],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,22,23,24,25,27]],
    [["if",4,10],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,22,23,24,25,27]],
    [["if",4,11],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,22,23,24,25,27]],
    [["if",4,12],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,22,23,24,25,27]],
    [["if",4,13],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,22,23,24,25,27]],
    [["if",4,14],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,22,23,24,25,27]],
    [["if",4,19],["block",3,9,12,15,25,27]],
    [["if",4,20],["block",3,9,12,15,25,27]],
    [["if",4,21],["block",3,9,12,15,25,27]]]
},
"runtime":[
[],[]
]};
...
var rc={},sc=null;rc.o="GTM-PJ8M5SK";var tc=null,uc="//www.googletagmanager.com/a?id="+rc.o+"&cv=20",vc={},wc={},xc=B.currentScript?B.currentScript.src:void 0;var yc=function(){},zc=function(a){return"function"==typeof a},Ac=function(a){return"string"==wa(a)},Bc=function(a){return"number"==wa(a)&&!isNaN(a)},Cc=function(a){return Math.round(Number(a))||0},Dc=function(a){return"false"==String(a).toLowerCase()?!1:!!a},Ec=function(a){var b=[];if(pa(a))for(var c=0;c<a.length;c++)b.push(String(a[c]));return b},Fc=function(a){return a?a.replace(/^\s+|\s+$/g,""):""},Gc=function(a,b){if(!Bc(a)||!Bc(b)||a>b)a=0,b=2147483647;return Math.floor(Math.random()*(b-a+1)+
